...
package io.rxmicro.benchmark.rxmicro.core;

import io.rxmicro.benchmark.rxmicro.core.server.RequestIdGeneratorBenchmark;
...
public final class Launcher {
    ...
    public static void launchBenchmark(final Class<?> benchmarkClass) throws RunnerException {
        final Options opts = new OptionsBuilder().include(benchmarkClass.getName())
                ...
                .result(format("%srxmicro-core-%s.txt", RESULT_FOLDER, benchmarkClass.getSimpleName()))
                .build();
        new Runner(opts).run();
    }
