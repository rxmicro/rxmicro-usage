...
package io.rxmicro.benchmark.rxmicro.component;

import io.rxmicro.benchmark.rxmicro.component.request.id.generator.RequestIdGeneratorBenchmark;
...
public final class Launcher {
    ...
    public static void launchBenchmark(final Class<?> benchmarkClass) throws RunnerException {
        final Options opts = new OptionsBuilder().include(benchmarkClass.getName())
                ...
                .result(format("%srxmicro-request-component-%s.txt", RESULT_FOLDER, benchmarkClass.getSimpleName()))
                .build();
        new Runner(opts).run();
    }
