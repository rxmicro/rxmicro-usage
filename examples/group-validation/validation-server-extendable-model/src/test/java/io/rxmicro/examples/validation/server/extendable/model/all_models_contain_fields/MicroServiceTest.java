...
final class MicroServiceTest {
    ...
    @CsvSource(delimiter = ';', value = {
            "grandParameter;    null;   Parameter \"grandParameter\" is required!",
            "grandParameter;    test;   Invalid parameter \"grandParameter\": Expected an uppercase string, but actual is 'test'!",
