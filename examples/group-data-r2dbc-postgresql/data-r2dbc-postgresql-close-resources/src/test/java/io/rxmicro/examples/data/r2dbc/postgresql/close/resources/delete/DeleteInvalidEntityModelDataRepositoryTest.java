...
@Testcontainers
@RxMicroComponentTest(DeleteInvalidEntityModelDataRepository.class)
final class DeleteInvalidEntityModelDataRepositoryTest extends AbstractDataRepositoryTest<DeleteInvalidEntityModelDataRepository> {
    ...
    private DeleteInvalidEntityModelDataRepository dataRepository;

    public DeleteInvalidEntityModelDataRepositoryTest() {
        super(true);
    }

    @Override
    protected DeleteInvalidEntityModelDataRepository getRepository() {
