...
final class MicroServiceTest {
    ...
    void get_should_return_valid_response1() {
        ...
        final ClientHttpResponse response = blockingHttpClient.get("/1/parentVar", headers, queryParams);
    ...
    void put_should_return_valid_response1() {
        ...
        final ClientHttpResponse response = blockingHttpClient.put("/1/parentVar", headers, body);
    ...
    void get_should_return_valid_response2() {
        ...
        final ClientHttpResponse response = blockingHttpClient.get("/2/parentVar", queryParams);
    ...
    void put_should_return_valid_response2() {
        ...
        final ClientHttpResponse response = blockingHttpClient.put("/2/parentVar", body);
