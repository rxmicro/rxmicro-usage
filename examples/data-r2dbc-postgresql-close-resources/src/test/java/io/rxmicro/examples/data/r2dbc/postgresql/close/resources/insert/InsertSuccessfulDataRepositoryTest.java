...
@Testcontainers
@RxMicroComponentTest(InsertSuccessfulDataRepository.class)
final class InsertSuccessfulDataRepositoryTest extends AbstractDataRepositoryTest<InsertSuccessfulDataRepository> {
    ...
    private InsertSuccessfulDataRepository dataRepository;

    public InsertSuccessfulDataRepositoryTest() {
        super(false);
    }

    @Override
    protected InsertSuccessfulDataRepository getRepository() {
