...
@Testcontainers
@RxMicroComponentTest(UpdateSuccessfulDataRepository.class)
final class UpdateSuccessfulDataRepositoryTest extends AbstractDataRepositoryTest<UpdateSuccessfulDataRepository> {
    ...
    private UpdateSuccessfulDataRepository dataRepository;

    public UpdateSuccessfulDataRepositoryTest() {
        super(false);
    }

    @Override
    protected UpdateSuccessfulDataRepository getRepository() {
