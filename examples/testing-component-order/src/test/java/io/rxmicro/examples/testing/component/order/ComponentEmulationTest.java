...
@ExtendWith(RxMicroComponentEmulationTestExtension.class)
public final class ComponentEmulationTest {
    ...
    public ComponentEmulationTest() {
        System.out.println("USER-TEST: new instance of the component test class created.");
    }
