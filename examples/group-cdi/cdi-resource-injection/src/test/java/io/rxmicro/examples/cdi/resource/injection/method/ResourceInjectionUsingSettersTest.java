...
@RxMicroComponentTest(ResourceInjectionUsingSetters.class)
final class ResourceInjectionUsingSettersTest {

    private ResourceInjectionUsingSetters resourceInjectionComponent;
