...
Такой результат связан с тем, что создав альтернативу-мок для компонента `ExternalMicroService`, в процессе тестирования не используются сгенерированные фреймворком RxMicro классы для работы REST клиента.
