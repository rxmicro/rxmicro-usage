...
Для интеграции с библиотеками, которые не поддерживают JPMS, фреймворк *RxMicro* позволяет активировать режим `unnamed module` для `RxMicro Annotation Processor`.
