...
[source,java]
----
include::{RX-MICRO-USAGE-ROOT-LOCAL-PATH}benchmarks/src/main/java/io/rxmicro/bencmark/rest/server/RequestIdGeneratorBenchmark.java[tag=content,indent=0]
----
...
[source,txt]
----
include::{RX-MICRO-USAGE-ROOT-LOCAL-PATH}benchmarks/results/RequestIdGeneratorBenchmark.txt[]
----
