...
Фреймворк RxMicro поддерживает также внедрение с помощью https://www.w3schools.com/java/java_encapsulation.asp[`setters` (method injection)^]:
...
При использовании механизма внедрения с помощью https://www.w3schools.com/java/java_encapsulation.asp[`setters`^], данный метод вызывается фреймворком RxMicro автоматически:
