...
Фреймворк RxMicro поддерживает создание классов-фабрик, которые могут использоваться для создания объектов других типов.
...
Внедрение объекта, создаваемого классом-фабрикой ничем не отличается от создания объекта фреймворком RxMicro:
