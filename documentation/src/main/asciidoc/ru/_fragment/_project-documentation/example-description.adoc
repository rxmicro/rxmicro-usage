...
разработчик может указать данные максимально приближенные к реальным, которые будут использоваться при построении примеров использования в проектной документации.

С помощью аннотации
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-documentation/src/main/java/io/rxmicro/documentation/Description.java[`@Description`^]
разработчик может указать подробное описание отдельных полей модели, которые будут использоваться при построении проектной документации.
