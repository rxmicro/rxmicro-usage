...
Для получения метаданных в процессе построения REST-based microservice documentation, фреймворк RxMicro может использовать:
...
Для указания метаданных, необходимых для генерации REST-based microservice documentation можно использовать аннотации модуля `rxmicro.documentation`.
