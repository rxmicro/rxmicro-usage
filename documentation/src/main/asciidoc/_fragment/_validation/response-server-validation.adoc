...
*By default, the RxMicro framework does not generate response validators!*
...
[source,java]
----
include::{RX-MICRO-USAGE-ROOT-LOCAL-PATH}examples/group-validation/validation-server-response/src/main/java/module-info.java[tag=content,indent=0]
----
