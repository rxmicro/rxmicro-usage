...
To work with configurations, RxMicro provides the
...
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L73[`Configs.getConfig`^] method:
...
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L85[`Configs.Builder`^] class:
