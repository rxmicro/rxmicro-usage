...
By default, the RxMicro reads configuration sources
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L42[in the following order^]:
