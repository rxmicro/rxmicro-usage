...
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L197[`Configs.Builder.withOrderedConfigSources`^] method:
...
====
The
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L198[`Configs.Builder.withOrderedConfigSources`^]
...
The
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L197[`Configs.Builder.withOrderedConfigSources`^]
method is universal.

The RxMicro framework also provides other additional methods:

* {RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L222[`Configs.Builder.withAllConfigSources`^] - activation of all configuration types in the order given by the list:
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/ConfigSource.java[`ConfigSource`^]

* {RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L240[`Configs.Builder.withContainerConfigSources`^] - this combination is recommended for microservices operating in https://www.docker.com/[docker^] or https://kubernetes.io/[kubernetes^].

[TIP]
====
The
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-config/src/main/java/io/rxmicro/config/Configs.java#L222[`Configs.Builder.withAllConfigSources`^]
