...
https://en.wikipedia.org/wiki/Multithreading_(computer_architecture)[multithreading programming model^],
the use of CPU and RAM is extremely inefficient.
...
The absence of blocking operations in the microservice allows to handle many concurrent connections, using a small number of threads and, as a result, to effectively use hardware resources of the computer.
