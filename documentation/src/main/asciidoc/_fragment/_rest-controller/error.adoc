...
_(This name is constant and is used by the <<{project-documentation}#project-documentation-section,`rxmicro.documentation`>> module when building the project documentation.)_
