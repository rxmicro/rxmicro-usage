...
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-http/src/main/java/io/rxmicro/http/HttpHeaders.java#L187[`Request-Id`^] HTTP additional header is used.
...
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-http/src/main/java/io/rxmicro/http/HttpHeaders.java#L187[`Request-Id`^] name,
...
RxMicro supports the following types of HTTP request id generators.
