...
The RxMicro framework allows to handle identical HTTP requests, differing *only* in HTTP method, by different handlers:
...
The RxMicro framework allows to handle HTTP requests on different URL Paths by different handlers:
