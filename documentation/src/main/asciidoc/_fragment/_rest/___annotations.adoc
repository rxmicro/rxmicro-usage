...
|Denotes an abstract class that contains <<rest-client-rest-client-generator-config-section,a partial implementation of the annotated REST client interface>>.
endif::[]
// ---------------------------------------------------------------------------------------------------------------------
|===
