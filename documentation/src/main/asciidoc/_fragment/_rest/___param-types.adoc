...
and also the `java.util.List<T>` type is parameterized by any of the above mentioned primitive types (except for `? extends Object` and `java.util.List<? extends Object>`).
