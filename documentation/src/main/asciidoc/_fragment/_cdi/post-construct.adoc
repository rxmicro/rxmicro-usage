...
_(Except for the constructor injection mechanism!)_. In order to run some code while creating an instance, but only after introducing all dependencies into this instance, the RxMicro framework provides a special
