...
|Denotes an abstract class that contains <<data-mongo-partial-implementation-section,a partial implementation of the annotated Mongo Data Repository interface>>.
// ---------------------------------------------------------------------------------------------------------------------
|===
