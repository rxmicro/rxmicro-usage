...
В качестве механизм подготовки базы данных к тестированию (создание базы данных перед запуском теста и удаление базы данных после завершения тестирования) удобнее всего использовать https://www.docker.com/[`docker`^].
