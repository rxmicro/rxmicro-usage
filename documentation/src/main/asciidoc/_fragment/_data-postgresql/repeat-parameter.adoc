...
[source,java]
----
include::{RX-MICRO-USAGE-ROOT-LOCAL-PATH}code-fragments/src/main/java/io/rxmicro/examples/code/fragments/postgres/PostgreSQLRepeatParameterRepository.java[tag=problem,indent=0]
----
...
[source,java]
----
include::{RX-MICRO-USAGE-ROOT-LOCAL-PATH}code-fragments/src/main/java/io/rxmicro/examples/code/fragments/postgres/PostgreSQLRepeatParameterRepository.java[tag=solution,indent=0]
----