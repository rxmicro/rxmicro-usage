...
{RX-MICRO-SRC-ROOT-BLOB-URL}rxmicro-test-mockito-junit/src/main/java/io/rxmicro/test/mockito/junit/InitMocks.java#L34[`@ExtendWith(MockitoExtension.class)`^] construction.)_
|===
