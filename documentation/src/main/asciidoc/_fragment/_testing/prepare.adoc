...
To solve <<testing-how-it-works-section,problems with the Java module system>> when writing the tests,
it is necessary to add the additional execution to the `maven-compiler-plugin` configuration:
